...
type RentalOverviewCard = {
  title: string;
  description: string;
};

type RentalOverviewProps = {
  title?: string;
  description?: string;
  cards?: RentalOverviewCard[];
};

const RentalOverview = ({
  title = "Rental Program",
  description = "Our rental program provides established or aspiring aestheticians access to premium GentleMax Pro laser equipment with complete support and training.",
  cards = RENTAL_OVERVIEW_CARDS,
}: RentalOverviewProps) => (
